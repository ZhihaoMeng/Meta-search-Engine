...
public class PathOfAgentsClass {
	...
	private static String msCFRecommAgentPath = "agent.agentclass.workingagent.CFRecommAgent";
	
	private static String resultCalculateInitScoreAgentPath = "agent.agentclass.workingagent.ResultCalculateInitScoreAgent";
	private static String resultRemoveDuplicateAgentPath = "agent.agentclass.workingagent.ResultRemoveDuplicateAgent";
	private static String searchEngineWeightAgentPath = "agent.agentclass.workingagent.SearchEngineWeightAgent";
	
	public static String ResultCalculateInitScoreAgent()
	{
		return resultCalculateInitScoreAgentPath;
	}
	public static String ResultRemoveDuplicateAgent()
	{
		return resultRemoveDuplicateAgentPath;
	}
	public static String SearchEngineWeightAgent()
	{
		return searchEngineWeightAgentPath;
	}
	...
	public static String CFRecommAgent(){
		return msCFRecommAgentPath;
	}
}
