...
public class ServiceNamesOfAgent {
	...
	public final static String CF_RECOMMENDATION = "cf-recomm";
	public final static String USER_CLUSTER = "user-cluster";
	
	//add by wenyuanliu 20160330
	public final static String SEARCH_ENGINE_WEIGHT = "search-engine-weight";
	public final static String RESULT_REMOVE_DUPLICATE = "result-remove-duplicate";
	public final static String RESULT_CALCULATE_SCORE = "result-calculate-score";
}
