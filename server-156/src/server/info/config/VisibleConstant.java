...
public class VisibleConstant {
	...
	public enum ContentNames{
			...
			/*74*/lang_setting_entry,
			/*75*/home,
			/*76*/address,
			/*77*/job,
			/*78*/company,
			/*79*/home_prompt,
			/*80*/address_job_company_prompt,
			/*81*/home_select_prompt,
			/*81*/address_select_prompt,
			/*81*/job_select_prompt,
			/*81*/company_select_prompt,
			/*82*/city_select_prompt,
			/*83*/tab_academic
	};
	...
	private final static String CONTENT_EN[]={
			...
			/*77*/"Job",
			/*78*/"Company",
			/*79*/"Please select your hometown",
			/*80*/"Please select your address, job and company",
			/*81*/"--select home--",
			/*81*/"--select address--",
			/*81*/"--select job--",
			/*81*/"--select company--",
