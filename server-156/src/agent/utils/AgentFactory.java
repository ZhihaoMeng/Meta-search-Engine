...
public class AgentFactory {
	...
	//add by elaine at 20160426
	private final static int RESULT_CAL_SCORE_AGNET_AMOUNT = 1;
	private final static int RESULT_REMOVE_DUPLICATE_AGENT_AMOUNT = 1;
	private final static int SEARCH_ENGINE_WEIGHT_AGENT_AMOUNT = 1;
	private final static int CF_RECOMM_AGENT_AMOUNT = 1;
	...
	private final static String[] CF_RECOMM_AGENT_NAMES = new String[CF_RECOMM_AGENT_AMOUNT];
	
	//add by elaine at 20160426
	private final static String[] RESULT_CAL_SCORE_AGNET_NAMES = new String[RESULT_CAL_SCORE_AGNET_AMOUNT];
	private final static String[] RESULT_REMOVE_DUPLICATE_AGENT_NAMES = new String[RESULT_REMOVE_DUPLICATE_AGENT_AMOUNT];
	private final static String[] SEARCH_ENGINE_WEIGHT_AGENT_NAMES = new String[SEARCH_ENGINE_WEIGHT_AGENT_AMOUNT];
	...
	static {
		...
		initCFRecommAgentDefaultNames();
		
		initResultCalInitScoreAgentDefaultNames();
		initReslutRemoveDuplicateAgentDefaultNames();
		initSearchEngineWeightAgentDefaultNames();

		

	}
	
	private static void initResultCalInitScoreAgentDefaultNames()
	{
		for (int i = 0; i < RESULT_CAL_SCORE_AGNET_AMOUNT; i++) {
			RESULT_CAL_SCORE_AGNET_NAMES[i] = "result-calculate-initscore-agent-" + i;
		}
	}
	private static void initReslutRemoveDuplicateAgentDefaultNames()
	{
		for (int i = 0; i < RESULT_REMOVE_DUPLICATE_AGENT_AMOUNT; i++) {
			RESULT_REMOVE_DUPLICATE_AGENT_NAMES[i] = "result-remove-duplicate-agent-" + i;
		}
	}
	private static void initSearchEngineWeightAgentDefaultNames()
	{
		for (int i = 0; i < SEARCH_ENGINE_WEIGHT_AGENT_AMOUNT; i++) {
			SEARCH_ENGINE_WEIGHT_AGENT_NAMES[i] = "search-engine-weight-agent-" + i;
		}
	}
	...
	private static void initCFRecommAgentDefaultNames(){
		for (int i = 0; i < CF_RECOMM_AGENT_AMOUNT; i++) {
			CF_RECOMM_AGENT_NAMES[i] = "cf-recomm-agent-" + i; 
		}
	}
	...
	final static private String[] ELEMENT_NAMES={
		...
		"GroupDivideAgent",
		"CFRecommAgent",		
		"ResultCalculateInitScoreAgent",
		"ResultRemoveDuplicateAgent",
		"SearchEngineWeightAgent"		
	...
	final static private String[] AGENT_CLASSPATH={
		...
		PathOfAgentsClass.CFRecommAgent(),
		
		PathOfAgentsClass.ResultCalculateInitScoreAgent(),
		PathOfAgentsClass.ResultRemoveDuplicateAgent(),
		PathOfAgentsClass.SearchEngineWeightAgent()
	...
	final static private String[][] AGENT_DEFAULT_NAMES={
		...
		GROUP_DIVIDE_NAMES,
		CF_RECOMM_AGENT_NAMES,		
		RESULT_CAL_SCORE_AGNET_NAMES,
		RESULT_REMOVE_DUPLICATE_AGENT_NAMES,
		SEARCH_ENGINE_WEIGHT_AGENT_NAMES
