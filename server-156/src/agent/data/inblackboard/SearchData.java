...
public class SearchData extends BlackboardBaseData{
	...
	public static int searchEngineCount;//使用的搜索引擎个数
	...
	public void memberSearchFinish(){
		...
		searchEngineCount = m_nMemberSearchDoneCount;
		//System.out.println("searchEngineCount: "+searchEngineCount);
	}
	...
	public int getMemberSearchAmount(){
		//return m_nMemberSearchDoneCount;
		return m_nMemberSearchEngineCount;
	}
	...
	public void saveCFRecommResult(List<Result> ls) {
		...
		if (null != m_sdcPoolItem)
			m_sdcPoolItem.setClickRecommResult(ls);
	}
