...
public class InterfaceAgent extends Agent implements AIDUpdator{
	...
	private AgentIDPool mCFRecommAgentPool;
	...
	protected void initReceiverAIDPool() {
		...
		mCFRecommAgentPool = new AgentIDPool();
	}
	...
	public AID getReceiver(InterfaceAgentTxType type) {
		...
		case groupDivide:
			...
			break;
		case cfRecomm:
			ret = mCFRecommAgentPool.getNext();
		default:
			break;
		}
	...
	public boolean updateAIDPool() {
		...
		AIDPoolUpdateUtil.updatePool(ServiceNamesOfAgent.CF_RECOMMENDATION, mCFRecommAgentPool, this, dfd, sd);
		return true;
	}
