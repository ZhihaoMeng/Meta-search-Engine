...
import common.functions.recommendation.click.CFRecommendation;
import db.dbhelpler.UserGroupHelper;
import jade.core.behaviours.Behaviour;
import jade.lang.acl.ACLMessage;

public class CFRecommBehaviour extends Behaviour {
	...
	public void action() {
		...
		if(null!=msg){
			...
			if(checkGroupUserID()){
				m_lsRecommRes.clear();
				CFRecommendation.getCFRecommendation(m_lsRecommRes, m_strQuery,m_nUserid);
				m_sdcBlackboardData.saveCFRecommResult(m_lsRecommRes);
			}
